...
public class GroupService {
    ...
    public PaymentGraph getGroupPaymentGraph(final String groupId, final String stringId) throws IllegalAccessException
    {

        final BalanceMap resultExpenses = getBalances(groupId, stringId);
    ...
    public BalanceMap getBalances(final String groupId, final String stringId) throws IllegalAccessException {

        if (!groups.get(groupId).getUsers().contains(stringId))
        {
